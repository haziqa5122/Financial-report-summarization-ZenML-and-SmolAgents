...
def main(file_path: str):
    ...
    strategy_result = Client().get_artifact_version("strategic_direction_result").load()
    response_data = {"metric_result": metric_result, "context_result":context_result, "competitor_result": competitor_result, "risk_assesment_result": risk_result, "strategic_direction_result":strategy_result}
    logger.info(f"Running Agent Validation on the company's data")
    ...
    logger.info(f"Reporting on the Dashboard")
